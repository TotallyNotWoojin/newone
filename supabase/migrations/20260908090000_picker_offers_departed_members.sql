-- The people picker hid anyone who had ever been in the group.
--
-- Leaving or being removed keeps the membership row and marks it, and the
-- candidate list excluded every row regardless of status, so a person who left
-- could never be added back: the write path was fixed by 20260908070000, but
-- the picker never offered them in the first place.
