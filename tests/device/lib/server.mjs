...
// 6 s between polls (was 4 s): the hosted database is on a burst-IO tier and the
// suite's polling was a visible share of its disk budget (owner warning, Sep 4).
export async function waitFor(queryFn, predicate, { timeoutMs = 60_000, intervalMs = 6_000 } = {}) {
