...
test('native Edge routing inserts the exact function for auth, read, and command paths', () => {
  const cases = [
    ...
    ['/v2/conversations/00000000-0000-4000-8000-000000000001/projects/query', 'newone-read'],
    ['/v2/conversations/00000000-0000-4000-8000-000000000001/summaries/readiness', 'newone-read'],
    ['/v2/find/query', 'newone-read'],
    ['/v2/conversations/00000000-0000-4000-8000-000000000001/projects/commands', 'newone-api'],
